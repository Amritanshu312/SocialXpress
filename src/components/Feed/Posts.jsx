import { collection, deleteDoc, doc, getDocs, limit, orderBy, query, onSnapshot } from "firebase/firestore";
...
const Posts = () => {
  ...
  return (
    ...
    >
      {FeedData.map((data) => (
        <div className="Feed_post" key={data.id}>
